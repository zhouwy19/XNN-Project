...
This is a port of the official implementation of [Fréchet Inception Distance](https://arxiv.org/abs/1706.08500) to Jittor. It is converted from [mseitzer/pytorch-fid](https://github.com/mseitzer/pytorch-fid) and maintained at [alexfanqi/jittor-fid](https://github.com/alexfanqi/jittor-fid).
